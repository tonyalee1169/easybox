...
(d.offsetHeight!=l||d.offsetWidth!=h)&&a(d).animate({height:l,marginTop:-l/2,width:h,marginLeft:-h/2},c.resizeDuration,c.resizeEasing);a(d).queue(function(){a(n).css({width:h,marginLeft:-h/2,marginTop:l/2});a(j).css({marginLeft:-h/2-Math.floor(a(j).width()*1.5)});a(o).css({marginLeft:h/2+Math.ceil(a(j).width()*0.5)});a(m).css({display:"none",visibility:"",opacity:""});f!=null&&a(f).css({display:"block"}).appendTo(m);a(m).fadeIn(c.fadeDuration,aa);c.slideshow&&k>=0&&!v&&i==null&&(i=setInterval(s?A:
z,c.slideshow));c.autoClose&&(C=setInterval(y,c.autoClose))})}function aa(){p>=0&&a(j).css({display:"none",visibility:"",opacity:""}).fadeIn(c.captionFadeDuration);k>=0&&a(o).css({display:"none",visibility:"",opacity:""}).fadeIn(c.captionFadeDuration);a(n).css({opacity:""}).fadeIn(c.captionFadeDuration);a(D).css("marginTop",-D.offsetHeight).animate({marginTop:0},c.captionFadeDuration)}function G(){var b;a(d).removeClass();if(q!=null)b=q.onload=q.onerror=null,q=b;w!=null&&(w.abort(),w=null);i!=null&&
(clearInterval(i),i=null);C!=null&&(clearInterval(C),C=null);r!=null&&(a(O).append(a(r).css({display:""})),r=O=null);J=u=!1;K=L=H=I=0;a(m).empty();a([d,D]).stop(!0);a([m,n,j,o]).stop(!0).css({display:"none"})}function ba(){v=!v;s=!1;a(P).toggleClass("disabled",v);v?i!=null&&(clearInterval(i),i=null):c.slideshow&&k>=0&&i==null&&(i=setInterval(s?A:z,c.slideshow));return!1}function y(){g>=0&&(G(),g=p=k=-1,s=v=!1,a(Q).stop().fadeOut(c.fadeDuration,S),a(d).animate({height:c.closeHeight,marginTop:-c.closeHeight/
2,width:c.closeWidth,marginLeft:-c.closeWidth/2,opacity:0},c.fadeDuration,function(){R();a([d,n,j,o]).css({left:"",top:""});a(d).hide()}));return!1}function T(){return/(\.jpg|\.jpeg|\.png|\.gif)$/i.test(e[g][0])}function U(){var a=/^http\:\/\/www\.youtube\.com\/watch\?v=([A-Za-z0-9\-_]*)(&(.*))?$/i.exec(e[g][0]);return a!=null?a[1]:!1}function V(){var a=/^http\:\/\/vimeo\.com\/([0-9]*)(.*)?$/i.exec(e[g][0]);return a!=null?a[1]:!1}function $(){var b=/^(.*)\#([A-Za-z0-9\-_]*)$/i.exec(e[g][0]);return b!=
null&&a("#"+b[2]).length?b[2]:!1}function x(a){if(!(a.w>0&&a.h>0))a.w=c.defWidth,a.h=c.defHeight;if(a.h>c.maxHeight)a.w=Math.round(c.maxHeight*a.w/a.h),a.h=c.maxHeight;if(a.w>c.maxWidth)a.h=Math.round(c.maxWidth/a.w*a.h),a.w=c.maxWidth;return a}function ca(b){if(c.dragDrop)return E=!0,a([d,n,j,o]).css({cursor:"pointer"}),W=b.pageX-a(this).position().left,X=b.pageY-a(this).position().top,!1}function da(b){if(c.dragDrop&&E){var f=b.pageX-a(window).scrollLeft()-W,b=b.pageY-a(window).scrollTop()-X;a([d,
n,j,o]).css({left:f+"px",top:b+"px"})}}function R(){E&&(E=!1,a([d,n,j,o]).css({cursor:""}))}var c,e,g=-1,p,k,h,l,F=[],s=!1,v=!1,E=!1,W=0,X=0,q=null,w=null,r=null,O=null,i=null,C=null,H=0,I=0,K=0,L=0,J=0,u=!1,Q,d,m,j,o,P,n,D,M,N;a(function(){a("body").append(a([Q=a('<div id="easyOverlay" />').click(y)[0],d=a('<div id="easyCenter" />').append([m=a('<div id="easyContainer" />')[0]])[0],j=a('<a id="easyPrevLink" href="#" />').click(A)[0],o=a('<a id="easyNextLink" href="#" />').click(z)[0],n=a('<div id="easyBottomContainer" />').append([D=
