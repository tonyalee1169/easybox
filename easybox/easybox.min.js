...
b('<div id="easyContainer" />')[0],v=b('<div id="easyLoadingIndicator" />')[0],w=b('<div id="easyBottom" />').append([D=b('<div id="easyNavigation" />').append([E=b('<a id="easyPrevLink" href="#" />').click(t)[0],F=b('<a id="easyNextLink" href="#" />').click(u)[0]])[0],U=b('<a id="easyCloseLink" href="#" />').click(J)[0],K=b('<a id="easySlideLink" href="#" />').click(Y)[0],m=b('<div id="easyCaption" />')[0],n=b('<div id="easyNumber" />')[0],b('<div style="clear: both;" />')[0]])[0]])[0]]).css("display",
"none"))});b.fn.easybox=function(a,c,d,h){var c=c||function(a){var b={url:a.href,caption:a.title};if(a.hasAttribute("data-width"))b.width=a.getAttribute("data-width");if(a.hasAttribute("data-height"))b.height=a.getAttribute("data-height");return b},d=d||function(a){return this==a},h=h||function(){return{}},g=this;return g.unbind("click").click(function(){var e=this,j=0,f,i=0,k;f=b.grep(g,function(a,b){return d.call(e,a,b)});for(k=f.length;i<k;++i)f[i]==e&&(j=i),f[i]=c(f[i],i);return b.easybox(f,j,
b.extend({},a,h(e)))})};b.easybox=function(a,f,e){if(o)return!1;c=b.extend({},N,e);var e=0,g;d=[];for(g=a.length;e<g;++e)d.push(b.extend({caption:"",width:0,height:0},a[e],{handler:null,loaded:!1,loading:!1,error:!1,obj:null}));if(d.length)return o=!0,c.loop=c.loop&&1<d.length,c.slideshow=c.slideshow&&1<d.length?c.slideshow:0,b(K).removeClass("disabled").css({display:c.slideshow&&1<d.length&&!c.hideButtons?"":"none"}),p=q=!1,b(U).css({display:!c.hideButtons?"":"none"}),i=c.initCenterSize.slice(),
A(),Q(1),b(h).show(),b(I).css({opacity:c.overlayOpacity}).fadeIn(c.fadeDuration,function(){z(Math.min(d.length-1,f||0))}),!1};b.easybox.previous=function(){return 0<=j?!t():!1};b.easybox.next=function(){return 0<=f?!u():!1};b.easybox.close=function(){return o?!G():!1};b.easybox.isOpen=function(){return o};b.easybox.defaults=function(a){N=b.extend(N,a)};b.easybox.resourceHandler=function(a){x.push(b.extend({identify:function(){return!1},preLoad:function(a,b){b()},postLoad:function(){},abort:function(){},
show:function(){},hide:function(){}},a))};b.easing.easybox=function(a){return 0.7>a?1.2*Math.pow(a/0.7,2):1.2-0.2*Math.sqrt((a-0.7)/(1-0.7))}})(jQuery);
