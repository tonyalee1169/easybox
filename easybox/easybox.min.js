...
(b.loop?0:-1);P();b.busyTimeout&&(J=setTimeout(ma,b.busyTimeout));if(0<=j&&/(\.jpg|\.jpeg|\.png|\.gif)$/i.test(d[j][0]))(new Image).src=d[j][0];if(0<=i&&/(\.jpg|\.jpeg|\.png|\.gif)$/i.test(d[i][0]))(new Image).src=d[i][0];aa()?na():!1!=(id=ba())?ca(0,id):!1!=(id=da())?ca(1,id):v()}return!1}function v(){var c,f;a(z).hide();if(w)a(Q).show(),o=b.initWidth,m=b.initHeight,f=null;else{if(aa())c=A({w:B,h:C}),f=a('<img src="'+d[g][0]+'" width="'+c.w+'" height="'+c.h+'" alt="'+d[g][1]+'" />');else if(!1!=
(id=ba())){var e="?version=3&autohide=1&autoplay=1&rel=0";if(b.ytPlayerTheme&&null!=(r=/^([a-z]*),([a-z]*)$/.exec(b.ytPlayerTheme)))e+="&theme="+r[1]+"&color="+r[2];b.loopVideos&&(e+="&loop=1&playlist="+id);c=A({w:Math.round(b.ytPlayerHeight*(R?16/9:4/3)),h:b.ytPlayerHeight});f=a('<iframe src="http://www.youtube.com/embed/'+id+e+'" width="'+c.w+'" height="'+c.h+'" frameborder="0"></iframe>')}else!1!=(id=da())?(e="?title=0&byline=0&portrait=0&autoplay=true",c=A({w:B,h:C}),b.loopVideos&&(e+="&loop=true"),
f=a('<iframe src="http://player.vimeo.com/video/'+id+e+'" width="'+c.w+'" height="'+c.h+'" frameborder="0"></iframe>')):!1!=(id=oa())?(n=a("#"+id)[0],S=a(n).parent(),T=a(n).css("display"),c=A({w:a(n).width(),h:a(n).height()}),f=a(n)):(c=A({}),f=a('<iframe width="'+c.w+'" height="'+c.h+'" src="'+d[g][0]+'" frameborder="0"></iframe>'));a(k).css({visibility:"hidden",display:""}).width(c.w).height(c.h);o=k.offsetWidth;m=k.offsetHeight;d[g][1].length&&a(D).html(d[g][1]).css({display:""});1<d.length&&b.counterText.length&&
a(E).html(b.counterText.replace(/{x}/,g+1).replace(/{y}/,d.length)).css({display:""})}(h.offsetHeight!=m||h.offsetWidth!=o)&&a(h).animate({height:m,marginTop:-m/2,width:o,marginLeft:-o/2},b.resizeDuration);a(h).queue(function(c){a(k).css({display:"none",visibility:"",opacity:""});null!=f&&a(f).css({display:"block"}).appendTo(k);a(k).fadeIn(b.fadeDuration,pa);Z();c()})}function pa(){x=!1;if(!b.hideBottom){if((0<=j||0<=i)&&!b.noNavigation&&!b.hideButtons)a(U).css({display:""}),a([D,E]).addClass("nav"),
0<=j&&a(q).fadeIn(b.captionFadeDuration),0<=i&&a(s).fadeIn(b.captionFadeDuration);a(F).fadeIn(b.captionFadeDuration);a(h).animate({height:m+F.offsetHeight},b.captionFadeDuration,b.resizeEasing)}}function P(){var c;x=!0;if(null!=p)c=p.onload=p.onerror=null,p=c;null!=K&&(K.abort(),K=null);null!=l&&(clearTimeout(l),l=null);null!=J&&(clearTimeout(J),J=null);null!=y&&(clearTimeout(y),y=null);null!=n&&(a(S).append(a(n).css({display:T})),n=S=T=null);R=w=!1;B=C=0;a(k).empty();a([h,F,k,q,s]).stop(!0);a(h).css({width:o,
height:m,marginLeft:-o/2,marginTop:-m/2,opacity:""});a([U,D,E,k,F,q,s]).css({display:"none",opacity:""});a([D,E]).removeClass().html("").css({display:b.hideCaption?"none":""});a([z,Q]).hide()}function qa(){u=!u;t=!1;a(V).toggleClass("disabled",u);u?null!=l&&(clearTimeout(l),l=null):Z();return!1}function G(c){if(!(b.noClose&&1!=c))return 0<=g&&(P(),g=j=i=-1,t=u=!1,a(W).stop().fadeOut(b.fadeDuration,X),a(h).animate({height:b.closeHeight,marginTop:-b.closeHeight/2,width:b.closeWidth,marginLeft:-b.closeWidth/
2,opacity:0},b.fadeDuration,function(){N();a([h,q,s]).css({left:"",top:""});a(h).hide()})),!1}function $(){G(1)}function ma(){x=!1}function aa(){return/(\.jpg|\.jpeg|\.png|\.gif)$/i.test(d[g][0])}function ba(){var a=/^http\:\/\/www\.youtube\.com\/watch\?v=([A-Za-z0-9\-_]*)(&(.*))?$/i.exec(d[g][0]);return null!=a?a[1]:!1}function da(){var a=/^http\:\/\/vimeo\.com\/([0-9]*)(.*)?$/i.exec(d[g][0]);return null!=a?a[1]:!1}function oa(){var c=/^(.*)\#([A-Za-z0-9\-_]*)$/i.exec(d[g][0]);return null!=c&&a("#"+
c[2]).length?c[2]:!1}function na(){a(z).show();p=new Image;p.onload=function(){B=this.width;C=this.height;v()};p.onerror=function(){w=!0;v()};p.src=d[g][0]}function ca(c,b){var e,d;a(z).show();d={type:"GET",dataType:"jsonp",timeout:2E3,error:function(a,c){"abort"!=c&&(w=!0,v())}};if(0==c)e="http://gdata.youtube.com/feeds/api/videos/"+b+"?v=2&alt=jsonc",d.success=function(a){!a.error&&a.data&&"allowed"==a.data.accessControl.embed?R="widescreen"==a.data.aspectRatio:w=!0;v()};else if(1==c)e="http://vimeo.com/api/v2/video/"+
...
!1):!0}function Y(c){if(b.dragDrop&&L){var d=c.pageX-a(window).scrollLeft()-fa,c=c.pageY-a(window).scrollTop()-ga;a(h).css({left:d+"px",top:c+"px"});return!1}return!0}function N(){return L?(L=!1,a([h,q,s]).css({cursor:""}),!1):!0}var ha,b,d,g=-1,j,i,o,m,M=[],t=!1,u=!1,L=!1,fa=0,ga=0,x=!1,p=null,K=null,n=null,S=null,T=null,J=null,l=null,y=null,B=0,C=0,R=0,w=!1,W,h,k,U,q,s,V,ia,F,D,E,z,Q;a(function(){ha={loop:!1,loopVideos:!1,dynOpts:!0,dragDrop:!0,hideBottom:!1,hideCaption:!1,hideButtons:!1,noNavigation:!1,
...
b.maxScreenFill),b.maxWidth),b.maxHeight=Math.min(Math.round(screen.height*b.maxScreenFill),b.maxHeight);b.loop=b.loop&&1<d.length;b.slideshow=b.slideshow&&1<d.length?b.slideshow:0;a(V).css({display:b.slideshow&&1<d.length&&!b.hideButtons?"":"none"});a(ia).css({display:!b.hideButtons?"":"none"});o=b.initWidth;m=b.initHeight;X(1);P();a(h).show();a(W).css("opacity",b.overlayOpacity).fadeIn(b.fadeDuration,function(){O(f)});return!1};a.easybox.close=$;a.easybox.isOpen=function(){return 0<=g};a.fn.easybox=
