...
!1;if(!b.hideBottom){if((0<=i||0<=f)&&!b.noNavigation&&!b.hideButtons)a(M).css({display:""}),a([q,r]).addClass("nav"),i||a(s).addClass("disabled"),f||a(t).addClass("disabled");a(y).fadeIn(b.captionFadeDuration);a(g).animate({height:l[1]+y.offsetHeight},b.captionFadeDuration,b.resizeEasing)}}function H(){u=!0;null!=k&&(clearTimeout(k),k=null);null!=A&&(clearTimeout(A),A=null);null!=x&&(clearTimeout(x),x=null);null!=p&&(a(K).append(a(p).css({display:L})),p=K=L=null);a(h).empty().removeClass();a([g,
